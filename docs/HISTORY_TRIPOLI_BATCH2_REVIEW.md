...
- **Draft ID:** `drafts.historyEntry.jom-d68726d23439a8e6135c869acacfd547`
- **Source ID:** `jom-history:xlsx-f163dbda3fd82eb1:Form:row-0104`
- **Sheet / row:** Form, row 104
- **Checksum:** `ee3b09857951bcaf588de88869a5c0fe3d98a0fb48e9f0da157f8b3e7d4e08e9` — unchanged
...
MENA / North Africa source topic tokens were not turned into new topics.
Europe and “British” were not mapped as geography.

## Source review

**Verified**

- Yad Vashem, [The Jews of Libya](https://www.yadvashem.org/articles/general/the-jews-of-libya.html)
- Yad Vashem Shoah Resource Center, [Libya](https://www.yadvashem.org/odot_pdf/Microsoft%20Word%20-%206407.pdf)
- JTA, 11 November 1945, contemporaneous Tripolitania report
...
- Wikipedia; commercial or stock URLs: none in this Form record

## Editorial review

The stored body is a long community history that overstates British
instigation, compresses the later emptying of Libya, and uses a death toll
that conflicts with Yad Vashem. The public layer is a short On This Day
notice using Yad Vashem’s 120-dead figure.
...
New place: **Tripoli** (`place.tripoli`).  
New region: **Africa** (`geographicRegion.africa`) — existing source token.  
Reuse topic: Antisemitism.  
No WWII era. No Holocaust topic. No MENA topic created.  
Warnings: antisemitic violence, death.  
`calendarSystem`: gregorian.

## Image / rights

None. No-image is acceptable.
