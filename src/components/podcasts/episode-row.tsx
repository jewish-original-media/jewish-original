...
import { EpisodeInlinePlayer } from "./episode-inline-player";

export function EpisodeRow({ episode }: { episode: PodcastEpisodeSummary }) {
  ...
  return (
    <article className="podcast-episode-row">
      <div className="podcast-episode-row__copy">
        ...
        {number ? (
          <p className="podcast-episode-card__number">{number}</p>
        ) : null}
        ...
        <p className="podcast-episode-row__detail">
          <Link href={href}>Episode page</Link>
        </p>
      </div>
