  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.body}>
        <Container className={styles.prose} size="content">
          <div>
            <p className={styles.copy}>
              Jewish Original Media started as a response: to loss, to longing,
              to the silence we felt in the spaces we loved.
            </p>
            <p className={styles.copy}>
              We don’t ask what’s going viral. We ask what’s worth remembering
              in 100 years.
            </p>
            <p className={styles.copy}>
              Each piece of content is stitched with kavod (honor), with
              chutzpah (courage), and with a fierce love of our people.
            </p>
            <p className={styles.copy}>
          ...
          <div>
            ...
            <p className={styles.copy}>
              ...
              conversations on Jewish meaning — across coffees, comment
              sections, and Shabbat tables — became a home for the Jewish story
              in real time.
            </p>
            <p className={styles.copy}>
              This isn’t a brand. It’s a movement of memory. We don’t just write
              headlines. We listen to whispers of history, translate the poetry
              of our people, and beam it back into the scrolls of your feed.
            </p>
            <p className={styles.copy}>
